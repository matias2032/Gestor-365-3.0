...
class _AlterarSenhaScreenState extends State<AlterarSenhaScreen> {
  ...
  Future<void> _alterarSenha() async {
    ...
    try {
     ...
     final senhaAtualCorreta = BCrypt.checkpw(senhaAtual, usuario.senhaHash);
      ...
      final senhaJaUsada = BCrypt.checkpw(novaSenha, senhaAnteriorHash);
    ...
    final novaSenhaHash = BCrypt.hashpw(novaSenha, BCrypt.gensalt());
  ...
  // 🔥 NOVO: Sincronizar mudança de senha
await SupabaseSyncService.instance.updateUsuario(usuarioAtualizado);
