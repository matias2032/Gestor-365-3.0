  ...
  Future<void> _trocarSenha() async {
    ...
    try {
      ...
      final novaSenhaHash = await FlutterBcrypt.hashPw(
        password: _novaSenhaController.text,
      ...
      final usuarioAtualizado = usuario.copyWith(
        ...
        primeiraSenha: 0, // 🔥 Marca que não é mais primeira senha
      );
      ...
      if (mounted) {
        ...
        // Aguarda 1 segundo e faz logout
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('❌ Erro ao trocar senha: $e'),
